...
<html lang="es">
  ...
  <body>
    <header>
      <nav>
        <ul class="navBar">
          <li class="menuMiTienda" onclick=showMyMenu()><a href="#"><p>NTP</p></a></li>
          <li>
      ...
      <ul class="menu-desplegable">
          <li onclick=hideMyMenu()><a class="a-icono-cerrar" href="#"><svg class="iconoCerrar" xmlns="http://www.w3.org/2000/svg" height="22px" width="22px" viewBox="0 -960 960 960" fill="#360000"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"/></svg></a></li>
          <li><a href="#"><p class="p-menuDesplegable">Colección</p></a></li>
          <li><a href="pages/spotify-section"><p class="p-menuDesplegable">Playlist</p></a></li>
          <li><a href="pages/newsletter.html"><p class="p-menuDesplegable">Newsletter</p></a></li>
      </ul>
    ...
    <article>
        ...
        <form method="post" class="disposicionPropuesta">
          ...
          <div class="elemento">
            ...
            <input type="text" spellcheck="false" autocorrect="off" autocomplete="off" name="nombre" id="input-nombre">
          </div>
